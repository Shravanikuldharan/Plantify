    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="relative space-y-4">
          ...
          {plant.saleBadge && (
            <span className="absolute top-4 left-4 bg-red-600 text-white px-3 py-1 rounded-md text-sm font-bold shadow-lg z-10">
        ...
        <div className="flex flex-col justify-start">
          ...
          {plant.saleDiscount > 0 ? (
            <>
              <p className="text-4xl font-semibold text-green-700 mb-1">
                ₹{discountedPrice}
              </p>
              <p className="line-through text-gray-500 text-lg mb-5">
                ₹{plant.price}
              </p>
            </>
          ) : (
