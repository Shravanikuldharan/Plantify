...
function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 mt-0 shadow-[0_-4px_12px_rgba(0,0,0,0.25)]">
        ...
        <div>
          ...
          <div className="flex gap-6 mt-4">
            ...
            <a
              ...
              target="_blank"
              className="text-gray-400 hover:text-white text-2xl transition-transform duration-300 transform hover:scale-125"
            >
              <FaGithub />
            </a>
